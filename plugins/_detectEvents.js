...
await this.sendMessage(m.chat, { text: `❘❚  𝗕 ͟ ͟ ͟ ㉀𝗧〘E⎯ XCLUS!VE〙❞\n\n» 𝙀𝙇 𝙂𝙍𝙐𝙋𝙊 𝙀𝙎𝙏𝘼 ${m.messageStubParameters[0] == 'on' ? '❝   𝖢𝖤𝖱𝖱𝖠𝖣𝖮 𝖢𝖮𝖭 𝖤𝖷𝖨𝖳𝖮  ❞' : '❝   𝖠𝖡𝖨𝖤𝖱𝖳𝖮 𝖢𝖮𝖭 𝖤𝖷𝖨𝖳𝖮  ❞'}\n ${m.messageStubParameters[0] == 'on' ? '㑤⃞   ㅤ  𝐆𝖱𝖴𝖯𝖮⎯𝖢𝖤𝖱𝖱𝖠𝖱        ▍' : '㑤⃞   ㅤ  𝐆𝖱𝖴𝖯𝖮⎯𝖠𝖡𝖱𝖨𝖱       ▍'} 𝙀𝙉 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊`, mentions: [m.sender] }, { quoted: fkontak, ephemeralExpiration: 24*60*100, disappearingMessagesInChat: 24*60*100})
} else if (m.messageStubType == 29) {
await this.sendMessage(m.chat, { text: `┣ *❘❚  𝗕 ͟ ͟ ͟ ㉀𝗧〘E⎯ XCLUS!VE〙❞ 𝑫𝑬𝑻𝑬𝑪𝑻𝑶 𝑵𝑼𝑬𝑽𝑶 𝑨𝑫𝑴𝑰𝑵* ┫\n\n *@${m.messageStubParameters[0].split`@`[0]}*\n *┣𝒀𝑨 𝑻𝑰𝑬𝑵𝑬 𝑳𝑶𝑺 𝑷𝑶𝑫𝑬𝑹𝑬𝑺 𝑫𝑬 𝑨𝑫𝑴𝑰𝑵* \n *┣𝑬𝑱𝑬𝑪𝑼𝑻𝑨𝑫𝑶 𝑷𝑶𝑹:*\n ${usuario}`, mentions: [`${m.sender}`,`${m.messageStubParameters[0]}`], mentions: (await conn.groupMetadata(m.chat)).participants.map(v => v.id) }, { quoted: fkontak, ephemeralExpiration: 24*60*100, disappearingMessagesInChat: 24*60*100})
} else if (m.messageStubType == 30) {
await this.sendMessage(m.chat, { text: `┣ *❘❚  𝗕 ͟ ͟ ͟ ㉀𝗧〘E⎯ XCLUS!VE〙❞ 𝑫𝑬𝑻𝑬𝑪𝑻𝑶 -1 𝑨𝑫𝑴𝑰𝑵* ┫\n\n *@${m.messageStubParameters[0].split`@`[0]}*\n *┣𝒀𝑨 𝑵𝑶 𝑻𝑰𝑬𝑵𝑬 𝑳𝑶𝑺 𝑷𝑶𝑫𝑬𝑹𝑬𝑺 𝑫𝑬 𝑨𝑫𝑴𝑰𝑵* \n *┣𝑬𝑱𝑬𝑪𝑼𝑻𝑨𝑫𝑶 𝑷𝑶𝑹:*\n ${usuario}`, mentions: [`${m.sender}`,`${m.messageStubParameters[0]}`], mentions: (await conn.groupMetadata(m.chat)).participants.map(v => v.id) }, { quoted: fkontak, ephemeralExpiration: 24*60*100, disappearingMessagesInChat: 24*60*100})
